...
public class Configuration
{
	...
	public static final String PREFS_KEY_BOB_PRECISION = "BOB_precision";
	...
	private static final String PREFS_KEY_BALANCE_IN_BTC = "show_balance_in_btc";
	...
	private int getBOBPrecision()
	{
		final String precision = prefs.getString(PREFS_KEY_BOB_PRECISION, null);
		if (precision != null)
			return precision.charAt(0) - '0';
		else
			return PREFS_DEFAULT_BOB_PRECISION;
	}

	public int getBOBShift()
	{
		final String precision = prefs.getString(PREFS_KEY_BOB_PRECISION, null);
		if (precision != null)
			return precision.length() == 3 ? precision.charAt(2) - '0' : 0;
		else
			return PREFS_DEFAULT_BOB_SHIFT;
	}

	public Coin getBOBBase()
	{
		final int shift = getBOBShift();
		if (shift == 0)
			return Coin.COIN;
		else if (shift == 3)
	...
	public MonetaryFormat getFormat()
	{
		...
		final int decimalRepetitions = (getBOBPrecision() - minPrecision) / 2;
	...
	{
		return prefs.getBoolean(PREFS_KEY_BALANCE_IN_BTC, true);
	}
