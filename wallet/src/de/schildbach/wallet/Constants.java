...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "dobbscoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "dobbscoin-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String USER_AGENT = "Dobbscoin Wallet";
