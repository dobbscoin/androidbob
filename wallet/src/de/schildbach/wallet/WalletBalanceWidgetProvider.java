...
public class WalletBalanceWidgetProvider extends AppWidgetProvider
{
			...
			final Bundle appWidgetOptions, final Coin balance)
	{
		...
		final Spannable balanceStr = new MonetarySpannable(BOBFormat.noCode(), balance).applyMarkup(null,
		...
		views.setOnClickPendingIntent(R.id.widget_button_balance, PendingIntent.getActivity(context, 0, new Intent(context, WalletActivity.class), PendingIntent.FLAG_IMMUTABLE));
		...
		views.setOnClickPendingIntent(R.id.widget_button_send, PendingIntent.getActivity(context, 0, new Intent(context, SendCoinsActivity.class), PendingIntent.FLAG_IMMUTABLE));
