...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private void notifyCoinsReceived(@Nullable final Address address, final Coin amount)
	{
		...
		final String tickerMsg = getString(R.string.notification_coins_received_msg, BOBFormat.format(amount)) + msgSuffix;
		final String msg = getString(R.string.notification_coins_received_msg, BOBFormat.format(notificationAccumulatedAmount)) + msgSuffix;
