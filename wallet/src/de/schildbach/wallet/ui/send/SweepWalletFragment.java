...
public class SweepWalletFragment extends Fragment
{
	...
	private void updateView()
	{
		...
		if (walletToSweep != null)
		{
			...
			final MonetarySpannable balanceSpannable = new MonetarySpannable(BOBFormat, walletToSweep.getBalance(BalanceType.ESTIMATED));
		...
		if (sentTransaction != null)
		{
			...
			sweepTransactionAdapter.setFormat(BOBFormat);
